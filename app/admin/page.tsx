        ...
        <section className="animate-fade-up space-y-5">
          <div className="flex items-end justify-between">
            ...
            <div className="flex items-center gap-1">
              <NavArrow dir="prev" label="Previous month" onClick={() => setAttendWeekOffset(o => o - 1)}/>
              <button onClick={() => setAttendWeekOffset(0)}
                className="text-xs font-mono px-3 h-10 sm:h-9 rounded-lg border border-border hover:border-ink text-muted hover:text-ink transition-all">This month</button>
              <NavArrow dir="next" label="Next month" onClick={() => setAttendWeekOffset(o => o + 1)}/>
            </div>
          </div>
